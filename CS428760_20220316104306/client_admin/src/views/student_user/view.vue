			...
			<el-col v-if="user_group === '管理员' || $check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="用户名" prop="user_name">
					<el-input id="user_name" v-model="form_sub['user_name']" placeholder="请输入用户名"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','user_name')) || (!form_sub['student_user_id'] && $check_field('add','user_name'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','full_name') || $check_field('add','full_name') || $check_field('set','full_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="姓名" prop="full_name">
					<el-input id="full_name" v-model="form_sub['full_name']" placeholder="请输入姓名"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','full_name')) || (!form_sub['student_user_id'] && $check_field('add','full_name'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','gender') || $check_field('add','gender') || $check_field('set','gender')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="性别" prop="gender">
					<el-select id="gender" v-model="form_sub['gender']"
						v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','gender')) || (!form_sub['student_user_id'] && $check_field('add','gender'))">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','major') || $check_field('add','major') || $check_field('set','major')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="专业" prop="major">
					<el-input id="major" v-model="form_sub['major']" placeholder="请输入专业"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','major')) || (!form_sub['student_user_id'] && $check_field('add','major'))"></el-input>
					<div v-else-if="$check_field('get','major')">{{form_sub['major']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','faculty') || $check_field('add','faculty') || $check_field('set','faculty')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="院系" prop="faculty">
					<el-input id="faculty" v-model="form_sub['faculty']" placeholder="请输入院系"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','faculty')) || (!form_sub['student_user_id'] && $check_field('add','faculty'))"></el-input>
