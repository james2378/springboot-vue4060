		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="用户名" prop="user_name">
					<el-input id="user_name" v-model="form_sub['user_name']" placeholder="请输入用户名"
							  v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','user_name')) || (!form_sub['teacher_user_id'] && $check_field('add','user_name'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','full_name') || $check_field('add','full_name') || $check_field('set','full_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="姓名" prop="full_name">
					<el-input id="full_name" v-model="form_sub['full_name']" placeholder="请输入姓名"
							  v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','full_name')) || (!form_sub['teacher_user_id'] && $check_field('add','full_name'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','gender') || $check_field('add','gender') || $check_field('set','gender')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="性别" prop="gender">
					<el-select id="gender" v-model="form_sub['gender']"
						v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','gender')) || (!form_sub['teacher_user_id'] && $check_field('add','gender'))">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','department') || $check_field('add','department') || $check_field('set','department')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="所在院系" prop="department">
					<el-input id="department" v-model="form_sub['department']" placeholder="请输入所在院系"
							  v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','department')) || (!form_sub['teacher_user_id'] && $check_field('add','department'))"></el-input>
